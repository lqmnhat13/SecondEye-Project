...
Phiên bản: 1.0.0
Cập nhật phạm vi: 2026-08-30
Áp dụng cho: obstacle, OCR tiếng Việt và VQA/scene.

Guide này phục vụ tạo ground truth cho đánh giá và bảo tồn taxonomy an toàn lịch
sử. MVP hiện tại dùng model pretrained, không fine-tune. Phần obstacle 15 lớp
không phải schema output của runtime COCO và không được trộn class ID với
`indoor_coco_baseline_v1`.
