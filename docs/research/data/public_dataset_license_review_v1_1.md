...
Phạm vi: hồ sơ lịch sử cho 10 lớp của schema SecondEye indoor v1.1 và cho khả
năng tái sử dụng dữ liệu trong nghiên cứu tương lai. MVP hiện dùng model
pretrained và không fine-tune. Đây là hồ sơ kỹ thuật, không phải tư vấn pháp lý.
