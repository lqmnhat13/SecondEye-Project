...
Adapter chỉ giữ sáu lớp có ánh xạ COCO sang SecondEye rõ ràng. Nhãn COCO không
có trong mapping bị loại, không được đổi tên gần đúng hoặc dùng để suy đoán lớp
SecondEye. Giá trị toàn cục 0.41 được giữ làm mốc benchmark; runtime dùng ngưỡng
riêng bắt buộc cho đủ sáu lớp được ánh xạ. Các ngưỡng này chỉ áp dụng cho YOLO26m
pretrained COCO; checkpoint fine-tuned giữ threshold 0.35 cho đến khi được
calibration riêng.
