...
Kế hoạch dùng tuần tương đối vì chưa có ngày bảo vệ chính thức. Trạng thái cập nhật ở `PROJECT_STATUS.md`.
...
| 7 | Khóa dữ liệu, chạy thí nghiệm | Test set manifest/hash; baseline và ablation | Config/seed/commit/device được ghi; dự đoán cấp mẫu đầy đủ |
...
| 3 | Tạo repo và môi trường Python | Đang làm; cấu trúc/pyproject đã có |
| 4 | Detection trên ảnh và webcam | Ảnh smoke đã có; webcam chưa chạy |
| 5 | OCR trên 20 ảnh development tiếng Việt | Chưa làm |
| 6 | Depth tại ba vùng khoảng cách | Chưa làm |
| 7 | Tổng hợp baseline và biên bản chốt | Chưa làm |

## Nếu chỉ còn 8 tuần

Gộp tuần 1-2 và 5-6; viết Chương 1-3 từ tuần 3. Bỏ mobile, fine-tune và user study chính thức. Không cắt test set độc lập, một ablation và phân tích failure cases.
